...
import { UI_addHTMLElement } from "./modules/UI/UI_DOM_Manipulation.js";
...
import { modal_USER_customization_Load } from "./modules/USER/USER_customization/USER_customization.js";
...
let HTML_addElement_div = document.getElementById('UI_addElement_div'); HTML_addElement_div.addEventListener('click', () => UI_addHTMLElement('div'));
export let HTML_addElement_P = document.getElementById('UI_addElement_p'); HTML_addElement_P.addEventListener('click', () => UI_addHTMLElement('p'));
